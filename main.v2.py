...
if __name__ == "__main__":
    ...
    while True:
        action = fonctions_base.afficher_accueil()  # Afficher l'écran d'accueil
        if action == "new_game":
            ...
            if nom_fichier:
                ...
                if result:
                    ...
                    boucle_jeu(grille.shape[0], regles, cellules_vivantes, still_lifes_data)  # Lancer le jeu avec les données chargées
            else:
